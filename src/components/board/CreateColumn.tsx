...
import { BoardColumn, addColumn } from '../../redux/boardSlice'
...
const CreateColumn = (props: Props) => {
    ...
    return <>
        <div className='board_column-container p-1.5'>
            <button className='board_column_create p-3 rounded-xl flex items-center font-bold' onClick={handleShow}>
                <span className='me-2'>
